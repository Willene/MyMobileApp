...
export class AuthService extends IonicAuth {
  ...
  private async addConfig() {
    ...
    const redirectUri = this.onDevice() ? 'com.okta.dev-87389316:/callback' : window.location.origin + '/callback';
    const logoutRedirectUri = this.onDevice() ? 'com.okta.dev-87389316:/logout' : window.location.origin + '/logout';
    const clientId = '0oakd4yvm7iT8LYtb5d6';
    const issuer = 'https://dev-87389316.okta.com';
